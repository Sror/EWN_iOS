...
@interface PullableView : UIView {
    ...
    UITapGestureRecognizer *__weak tapRecognizer;
    ...
    id<PullableViewDelegate> __weak delegate;
}
...
/**
 ...
 or created dependencies to other recognizers in your views.
 */
@property (weak, nonatomic,readonly) UITapGestureRecognizer *tapRecognizer;
